...
const FormComponent = () => {
  return (
    <div className="flex flex-col lg:flex-row w-full items-center justify-center pb-2 md:pb-5 lg:pb-10">
      <img
        src="/assets/icons/Mail-rafiki.svg"
        alt="callback"
        className="max-w-[50%] h-auto mx-auto"
      />
      <section className="p-6 shadow-xl bg-white md:w-[80vw] lg:w-8/12 space-y-10">
        ...
        whileTap={{ scale: 0.9 }}
          type="button"
          className="p-2 md:p-4 bg-blue-600 rounded-sm text-white font-semibold text-sm md:text-base"
        >
          Send Message
        </motion.button>
      </section>
